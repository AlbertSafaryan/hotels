  ...
  return (
    <div className='Confidence'>
        <div className="Container">
            ...
            <p className="Outercontent">Many properties have updated us about their enhanced health and safety measures. So, during your search, you may find details like:</p>
            <div className="Inner">
